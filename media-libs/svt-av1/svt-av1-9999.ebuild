...
if [[ ${PV} = 9999 ]]; then
  inherit git-r3
  EGIT_REPO_URI="https://github.com/Darkness4/svt-av1-psy.git"
else
  SRC_URI="https://github.com/gianni-rosato/svt-av1-psy/archive/refs/tags/v${_PV}.tar.gz -> ${P}.tar.gz"
  KEYWORDS="amd64 arm arm64 ~hppa ~ia64 ~loong ~mips ppc ppc64 ~riscv sparc x86"
  S="${WORKDIR}/svt-av1-psy-${_PV}"
fi
