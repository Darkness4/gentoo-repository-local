...
SRC_URI="https://github.com/freelensapp/${PN_CASE}/releases/download/v${PV}/${PN_CASE}-${PV}-linux-amd64.deb"
...
QA_PRESTRIPPED="/opt/Freelens/resources/x64/helm /opt/Freelens/resources/x64/kubectl"
