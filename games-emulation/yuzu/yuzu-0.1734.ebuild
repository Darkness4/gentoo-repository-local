...
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="+compatibility-reporting qt5 +qt6 sdl +cubeb llvm-libunwind +web-service +webengine"
REQUIRED_USE="|| ( qt5 qt6 sdl ) compatibility-reporting? ( web-service )"
...
src_configure() {
	...
	local mycmakeargs=(
		...
		-DENABLE_QT="$(usex qt5 yes "$(usex qt6)")"
		-DENABLE_QT6="$(usex qt6)"
		-DENABLE_QT_TRANSLATION="$(usex qt5 yes "$(usex qt6)")"
